...
module Tcx
  module Types
    ...
    class ExtensionsList < Base
      ...
      property 'TPX', transform_with: ->(v) { Tcx::Extensions::ActivityExtension::V2::Types::ActivityTrackpoint.parse(v) }

      # Lap extension (LX) - ActivityLapExtension_t
      # @return [ActivityLap, nil] lap extensions or nil
      property 'LX', transform_with: ->(v) { Tcx::Extensions::ActivityExtension::V2::Types::ActivityLap.parse(v) }
    end
  end
end
